<!-- Test the push 23 aaaasadjnkjas nkjdsns a time more -->
...
<section class="intro testing ahhh testing testing">
    ...
    <section id="schools" class="section-even">
        <div class="container">
            <div class="row">
                <h1 class="featurette-heading text-center ">Universities & Organizations</h1>
                <p class="lead text-primary text-center">Create and manage an entrepreneurship ecosystem with data-driven insights</p>
            </div>
            <div class="row featurette">
                
                <div class="col-md-6 col-sm-6 extrapadding ">
                    <div class="row ">
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa  fa-tasks fa-4x"></i></p>
                            <p class="lead">Portfolio Tracking</p> 
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa fa-user fa-4x"></i></p>
                            <p class="lead">Advising</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa fa-check-square-o fa-4x"></i></p>
                            <p class="lead">Tasks & Events</p>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa fa-tachometer fa-4x"></i></p>
                            <p class="lead">Performance Analytics</p>
                        </div>
                    </div>
                </div>
    ...
    <section id="students" class="section-odd">
    <div class="container">
            <div class="row">
                <h1 class="featurette-heading text-center ">Students & Entrepreneurs</h1>
                <p class="lead text-primary text-center">Lightweight and effective tools for students and entrepreneurs to get started</p>
            </div>
            <div class="row featurette">
                <div class="col-md-6 col-sm-6">
                ...
                <div class="col-md-6 col-sm-6 extrapadding ">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa  fa-th fa-4x"></i></p>
                            <p class="lead">Business Model Canvas</p> 
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa fa-search fa-4x"></i></p>
                            <p class="lead">People Search</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa fa-comments-o fa-4x"></i></p>
                            <p class="lead">Venture Page</p>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6 text-center productfeaturecell">
                            <p><i class="fa fa-crosshairs fa-4x"></i></p>
                            <p class="lead">Contextual Resources</p>
                        </div>
                    </div>
                </div>
